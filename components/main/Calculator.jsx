export default function Calculator() {
  return (
    <div>
      <section className="taxcalc bg-gray-100">
        <div className="max-w-screen-2xl mx-auto flex flex-col md:flex-row md:space-x-24 py-12 px-6 md:px-28 text-center md:text-left">
          <div className="hidden md:flex flex-1 py-3">
            <img
              width="500"
              height="500"
              loading="lazy"
          ...
          <div className="flex-1">
            <div>
              <h3 className="text-gray-800 text-base md:pb-3">
                2021 Income Tax Calculator
              </h3>
              <h4 className="text-black text-3xl px-3 md:px-0 py-3 leading-tight md:text-4xl font-bold tracking-tight ">
                See what your refund could look like.
              </h4>
            </div>

            <div className="flex md:hidden pb-square relative h-0 py-5">
              <picture className="h-full w-full absolute inset-0">
                <img
                  width="500"
                  height="500"
                  loading="lazy"
            ...
            <form
              method="POST"
              className="flex-1 md:grid md:grid-cols-2 md:gap-4"
            >
              <div className="py-2">
                <label
                  htmlFor="province"
                ...
                <select
                  required="required"
                  id="province"
                  className="mt-1 rounded-none focus:shadow-none outline-none focus:border-goldenrod-300 border-transparent border-2 block br-white form-select w-full py-2 px-3 border-gray-300 focus:outline-none focus:shadow-outline transition duration-150 ease-in-out sm:text-sm sm:leading-7"
                >
              ...
              <div className="py-2">
                ...
                <input
                  ...
                  step="1000"
                  className="focus:bg-white outline-transparent border-gray-200 focus:shadow-none focus:outline-none focus:border-goldenrod-300 border-2 rounded-none p-2 py-3 md:py-2.5 block transition duration-150 ease-in-out sm:leading-7 w-full"
                />
              </div>
              <div className="py-2">
                <label
